...
/*   Updated: 2019/04/17 11:44:16 by mdchane          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "liblem_in.h"

int		end_room(t_env *e, int j, char ***splt, int i)
{
	if (e->end)
	{
...
void	start_room(t_env *e, char **splt, int *type)
{
...
void	set_endroom(t_env *e, char **splt, int *type)
{
